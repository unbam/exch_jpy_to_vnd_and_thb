...
class __$$SuccessCopyWithImpl<$Res>
    extends _$ApiResultCopyWithImpl<$Res, _$Success>
...
class _$Success implements Success {
  const _$Success({required final Map<String, dynamic> data}) : _data = data;
...
abstract class Success implements ApiResult {
  const factory Success({required final Map<String, dynamic> data}) = _$Success;
...
class __$$FailureCopyWithImpl<$Res>
    extends _$ApiResultCopyWithImpl<$Res, _$Failure>
...
abstract class Failure implements ApiResult {
  const factory Failure({required final ApiError error}) = _$Failure;
